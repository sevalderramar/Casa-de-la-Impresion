...
@Import({SecurityConfig.class, SecurityConfigTest.TestController.class, SecurityConfigTest.TestBeans.class})
class SecurityConfigTest {
    ...
    public static class TestController {
        ...
        @GetMapping({"/auth/test", "/api/auth/test", "/h2-console/test", "/actuator/health", "/ruta-protegida"})
        String ok() {
            return "ok";
        }
    }
