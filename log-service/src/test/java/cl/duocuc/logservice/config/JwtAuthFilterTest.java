...
class JwtAuthFilterTest {
    ...
    @Test
    void doFilterInternalUsaRolUserCuandoTokenValidoTieneRolNull() throws ServletException, IOException {
        // Given
        when(request.getHeader("Authorization")).thenReturn("Bearer token-valido");
        when(jwtUtil.esValido("token-valido")).thenReturn(true);
        when(jwtUtil.extraerUsername("token-valido")).thenReturn("usuario@test.cl");
        when(jwtUtil.extraerRol("token-valido")).thenReturn(null);
    ...
    @Test
    void doFilterInternalUsaRolUserCuandoTokenValidoTieneRolVacio() throws ServletException, IOException {
        // Given
        when(request.getHeader("Authorization")).thenReturn("Bearer token-valido");
        when(jwtUtil.esValido("token-valido")).thenReturn(true);
        when(jwtUtil.extraerUsername("token-valido")).thenReturn("usuario@test.cl");
