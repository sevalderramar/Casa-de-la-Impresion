...
import cl.duocuc.logservice.exception.ConflictException;
import cl.duocuc.logservice.exception.ResourceNotFoundException;
...
class GlobalExceptionHandlerTest {
    ...
    void handleValidationRetornaPrimerMensajeDeError() throws NoSuchMethodException {
        ...
        bindingResult.addError(new FieldError("request", "servicio", "servicio obligatorio"));
        ...
        assertBody(response.getBody(), 400, "servicio obligatorio");
    }
