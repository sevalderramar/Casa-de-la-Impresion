...
| FB-08 | Eureka/discovery | Se documenta ausencia de Eureka y discovery estatico por Gateway/env | README, `docs/documentacion-tecnica.md` | Gateway usa URLs estaticas y variables de entorno | Parcial justificado |
...
| Sin Eureka real | Gateway resuelve rutas por configuracion estatica/env | Si la pauta exige discovery real, se debe implementar o justificar formalmente |
